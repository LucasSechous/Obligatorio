...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <main>
        ...
        <main>
            ...
            <asp:GridView ID="TablaTecnico1" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" OnSelectedIndexChanged="TablaTecnico1_SelectedIndexChanged">
